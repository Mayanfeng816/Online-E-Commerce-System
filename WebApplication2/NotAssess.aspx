<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="NotAssess.aspx.cs" Inherits="WebApplication2.NotAssess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div></div>
    <asp:GridView ID="GridView1" runat="server" style="margin-right: auto; margin-bottom: 10px;" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" Width="100%" GridLines="None" CssClass="auto-style6" Height="318px" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting" OnPageIndexChanging="GridView1_PageIndexChanging" ForeColor="#333333">
