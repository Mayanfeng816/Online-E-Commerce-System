...
<body class="bodymove">   
    <form id="form1" runat="server">
        <div class="div">
            <asp:Button ID="Button1" runat="server" Text="Admin" CssClass="Admin" OnClick="Button1_Click" UseSubmitBehavior="false"/>
            <p style="text-align: center;"><font size="6" class="font"><br/>数码产品购物网</font></p>
            <table class="table">
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br/>
                        <asp:Button ID="btnShopLogin" runat="server" Text="商 家" CssClass="btnregister" OnClick="btnShopLogin_Click"/>
                    </td>
                </tr>
            </table>
